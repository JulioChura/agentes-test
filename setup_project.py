...
PROJECT_NAME = "retailnova_agents"
...
POLICIES_FILE = "politicas_empresa.txt"
...
CENTRAL_WAREHOUSE_CITY = "Lima"
''',

    "src/database/__init__.py": "",
    "src/database/db_manager.py": '''import sqlite3
import pandas as pd
...
''',
    ...
    "src/rag/__init__.py": "",
    "src/rag/vector_store.py": '''import streamlit as st
...
''',
    ...
    "src/agents/tools.py": '''from crewai.tools import tool
...
''',
    ...
    "src/agents/crew_setup.py": '''from crewai import Agent, Task, Crew, Process, LLM
...
''',
    ...
    "src/utils/helpers.py": "# Funciones auxiliares (opcional)\n",
}

def create_project():
    if os.path.exists(BASE_DIR):
        respuesta = input(f"El directorio '{PROJECT_NAME}' ya existe. ¿Deseas sobrescribirlo? (s/N): ")
    ...
    print("\nProyecto creado exitosamente en:", BASE_DIR)
    print("\nSiguientes pasos:")
    print("1. cd retailnova_agents")
    print("2. Copia tus archivos retailnova.db y politicas_empresa.txt a esta carpeta")
